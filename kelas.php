				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title"> <i class="lnr lnr-cog"></i> Settings <i class="fa fa-angle-right"></i> <a href="kelas">Kelas</a> </h3>
							<p class="panel-subtitle">Halaman untuk mengelola kelas</p>
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<button type="button" class="btn btn-primary" data-toggle="modal" title="Tambah Kelas" data-target="#myModalthree" name="button">Tambah Kelas</button>
								</div>
							</div>
							<br>
							<div class="row">
								<div class="col-md-12">
									<table id="kelas" class="table display" style="width:100%">
										<thead>
												<tr>
														<th></th>
														<th>Nama Kelas</th>
										...
										<tbody>
											<?php
											$no = 1;
											$qy = mysqli_query($connect, "SELECT * FROM kelas, jurusan WHERE kelas.jurusan = jurusan.id_jurusan ORDER BY kelas.id_kelas ASC");
											while($q = mysqli_fetch_array($qy)) { ?>
												<tr>
													...
													<td class="text-center">
														<form class="" action="edit-kelas" method="post">
															<input type="hidden" name="id" value="<?= $q['id_kelas'] ?>">
													...
													<td>
														<form class="" action="hapus-kelas.php" method="post">
															<input type="hidden" name="id" value="<?= $q['id_kelas'] ?>">
