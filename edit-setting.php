<?php
include("header.php");
$qy = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM keterangan WHERE id = '$_POST[id]'"));
?>
		<!-- MAIN -->
		<div class="main">
			<!-- MAIN CONTENT -->
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title"> <i class="lnr lnr-cog"></i> Settings <i class="fa fa-angle-right"></i> <a href="kelas">Edit Kriteria Penilaian</a> </h3>
							<p class="panel-subtitle">Halaman untuk mengelola pengertian Kriteria Penilaian</p>
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<form class="" enctype="multipart/form-data" action="update-setting.php" method="post">
										<div class="modal-body">
												<div class="form-group">
													<label class="nk-label">Nama Kriteria Penilaian</label>
